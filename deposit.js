// deposit.js - Auto-Fetch with Skeleton & 24h Cache
...
(async function autoFetchPageData() {
    ...
    const BALANCE_CACHE_TTL = 5 * 60 * 1000; // 5 minutes for balance
    ...
    if (getCleanSessionToken()) {
        ...
        console.warn("⚠️ No session, skipping data fetch. Skeletons remain.");
        // Keep skeletons visible
    }
