// deposit.js - SPA‑Ready Page Controller (v3 - Hybrid Wait Fix)
window.initDepositPage = async function() {
    ...
    async function waitForSupabase() {
        return new Promise((resolve, reject) => {
            // 1. Ngati zilipo kale, pitilirani
            if (window.SUPABASE_URL && window.SUPABASE_ANON_KEY) {
                resolve(true);
                return;
            }

            // 2. Yikirani poller (imayang'ana kawiri-kawiri ngati zayikidwa)
            let attempts = 0;
            ...
            // 3. Mverani signal kuchokera ku supabase.js
    ...
    // ── DOM REFERENCES ── (Zotsalira zonse sizinakhudzidwe)
