// deposit.js - SPA‑Ready Page Controller (v5 - Central Turnstile Manager Integration)
window.initDepositPage = async function() {
    ...
    window.processDeposit = async function() {
        ...
        // ✅ NEW: Call router's centralized Turnstile Manager
        let token = await window.getTurnstileToken().catch(err => {
...
// ── LIFECYCLE HOOKS FOR ROUTER v11 ──
