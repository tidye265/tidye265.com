// deposit.js - Auto-Triggering Script (Event-Driven, Fixed Async Init)

// ── CORE FUNCTION: DEPOSIT PAGE INIT ──
// KONZETSA: Onjezani "async" kuti mugwiritse ntchito await mkati mwake!
async function initDepositPage() {
    "use strict";

    console.log("⚡ [DEPOSIT JS] Woken Up Automatically By Router (or direct load)!");
    ...
    // ── TURNSTILE (with fallback container) ──
