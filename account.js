...
// ── INIT ACCOUNT PAGE (Router imayimba iyi) ──
window.initAccountPage = async function() {
    ...
    // ── EXECUTE INIT (Router imayimba iyi) ──
    ...
    // 4. Offline/online listeners (ZOSINTHA: location.reload() yachotsedwa kuti asapange full refresh!)
