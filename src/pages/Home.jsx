        ...
        <>
            ...
            <div className="sticky-nav-holder">
                <header id="mainHeader">
                    <a href="/" className="logo-container"><img src="/logoo.jpg" alt="Tidye265 Logo" /></a>
                        ...
                        <div className="live-ticker-scroll">
                            <div className="live-ticker-track" id="liveTickerTrack">
                                {liveMatches.length === 0 ? (
                                    ...
                                    // Duplicate matches for infinite scroll animation
