        ...
        <>
            ...
            <div className="sticky-nav-holder">
                ...
                <nav className={`sub-header ${showMore ? 'show-more' : ''}`} id="categoryNav">
                    <a href="live.html" className="sub-item"><img src="live.svg" className="category-icon" alt="Live"/><span>Live</span><span className="live-badge">LIVE</span></a>
                    <a href="matches.html" className="sub-item"><img src="matches.svg" className="category-icon" alt="Sports"/><span>Sports</span></a>
                    <a href="casino.html" className="sub-item"><img src="casino.svg" className="category-icon" alt="Casino"/><span>Casino</span></a>
                    <a href="aviator.html" className="sub-item"><img src="aviator.png" className="category-icon" alt="Aviator"/><span>Aviator</span></a>
                    <a href="virtual.html" className="sub-item"><img src="vi.png" className="category-icon" alt="Virtual"/><span>Virtual</span><span className="virtual-badge">VIRTUAL</span></a>
