(function() {
    ...
    // 🔥 FIXED: DO NOT RENDER CACHED ODDS BEFORE FETCHING FRESH
    async function fetchMatches() {
        ...
        // ❌ REMOVED: const cachedOdds = getCached(CACHE_KEYS.ODDS); ...
        // ❌ REMOVED: if (cachedOdds) { oddsMap = cachedOdds; renderVisible(); }
        ...
        try {
            ...
            if (data.code === 0 && data.data) {
                ...
                // ✅ Clear stale odds cache so it doesn't render old demo odds
                localStorage.removeItem(CACHE_KEYS.ODDS);
    ...
    function renderVisible() {
        ...
        visible.forEach(m => {
            ...
            // ✅ No fallback to default odds - if not found, show "Odds not available"
