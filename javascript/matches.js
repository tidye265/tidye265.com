(function() {
    ...
    async function fetchMatches() {
        ...
        if (cachedMatches) {
            ...
            buildDateFilter();
            buildMarketFilter();
            // ✅ Render immediately with cached matches (even if odds not loaded)
            renderVisible();
        }
        ...
        try {
            ...
            if (data.code === 0 && data.data) {
                ...
                buildLeagueFilter();
                buildDateFilter();
                // ✅ Render immediately before fetching odds (so matches show up instantly)
                renderVisible();
            ...
            console.error(e);
            // If we have cached matches, keep showing them; else show error
