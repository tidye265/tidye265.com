...
const AccountPage = () => {
    ...
    useEffect(() => {
        if (footerHtml && footerRef.current) {
            ...
            // Re‑execute scripts inside footer
            ...
            <div className="sticky-nav-holder">
                <header id="mainHeader">
                    ...
                    <div className="header-controls">
                        ...
                        <a href="deposit.html" className="header-balance-container" id="walletTrigger">
                ...
                <nav className={`sub-header ${showMore ? 'show-more' : ''}`} id="categoryNav">
                    <a href="live.html" className="sub-item" data-category="live"><img src="live.svg" className="category-icon" alt="Live"/><span>Live</span><span className="live-badge">LIVE</span></a>
                    <a href="matches.html" className="sub-item" data-category="matches"><img src="matches.svg" className="category-icon" alt="Sports"/><span>Sports</span></a>
                    <a href="casino.html" className="sub-item" data-category="casino"><img src="casino.svg" className="category-icon" alt="Casino"/><span>Casino</span></a>
                    <a href="casino.html" className="sub-item" data-category="aviator"><img src="aviator.png" className="category-icon" alt="Aviator"/><span>Aviator</span></a>
                    <a href="virtual.html" className="sub-item" data-category="virtual"><img src="vi.png" className="category-icon" alt="Virtual"/><span>Virtual</span><span className="virtual-badge">VIRTUAL</span></a>
                    ...
                    <div className="more-items" id="moreCategories">
                        <a href="games.html" className="sub-item"><img src="games.svg" className="category-icon" alt="Games"/><span>Games</span></a>
                        <a href="esports.html" className="sub-item"><img src="games.svg" className="category-icon" alt="eSports"/><span>eSports</span></a>
                    </div>
                </nav>
            </div>
                        ...
                        <div style={{ flex: 1 }}>
                            {!isProfileLoaded ? (
                                ...
                                <>
                                    ...
                                    <a href="settings.html" className="profile-edit"><i className="bi bi-pencil-square"></i> Edit Profile</a>
                                </>
                            )}
                        </div>
                    </div>
