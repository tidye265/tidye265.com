// router.js - Ultra SPA Engine for tiDye265
(function() {
    'use strict';
    ...
    async function loadPage(url) {
        try {
            ...
            // 5. Imbani init yomwe ili mu page (ngati ilipo) – Gwiritsani ntchito await!
            if (typeof window.init === 'function') {
                try { await window.init(); } catch (e) { console.warn('init error:', e); }
            }
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        // Imbani loadPage pa page yoyamba kuti init igwire ntchito ndi await!
