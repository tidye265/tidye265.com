...
(function() {
    ...
    // Kuchotsa ma script akale kuti asasemphane (prevent "Identifier already declared")
    ...
    async function loadPage(url) {
        try {
            ...
            // 1. Yeretsani #app-content (sinthani content yokha, osati header/subheader)
            ...
            // 5. Imbani pageInit yomwe ili mu deposit.html (ngati ilipo)
