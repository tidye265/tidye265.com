// supabase.js - Wokonzedwa kuti azituma signal kwa SPA
(function() {
    'use strict';
    ...
    if (typeof supabase !== 'undefined') {
        ...
        console.error("[SUPABASE CRITICAL] Supabase CDN library is missing!");
    }

    // 🟢 FUNANI KUTUMIZA UTIHENGA KUTI deposit.js idziwe kuti yakonzeka
